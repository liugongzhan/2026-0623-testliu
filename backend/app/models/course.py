from sqlalchemy import text, Column, BigInteger, Integer, String, Text, DECIMAL, DateTime, ForeignKey
...
class Course(Base):
    ...
    teacher_id = Column(Integer, ForeignKey("sys_user.id", ondelete="RESTRICT"), nullable=False)
